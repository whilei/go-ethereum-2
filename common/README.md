...
[![Build
Status](https://travis-ci.org/ethereumclassic/go-ethereum.png?branch=master)](https://travis-ci.org/ethereum/go-ethereum)
...
`go get github.com/ethereumclassic/go-ethereum`.

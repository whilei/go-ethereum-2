...
Releases considered __stable__ may be found on our [Releases Page](https://github.com/ethereumclassic/go-ethereum/releases).
...
#### Consensus
- [ECIP-1017](https://github.com/ethereumclassic/ECIPs/blob/master/ECIPs/ECIP-1017.md) - implement monetary policy on Morden Testnet (2 million block era) and Mainnet (5 million block era)
...
Wiki: https://github.com/ethereumclassic/go-ethereum/wiki/Release-3.5.0-Notes
...
Wiki: https://github.com/ethereumclassic/go-ethereum/wiki/Release-3.4.0-Notes
